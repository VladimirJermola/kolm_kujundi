...
class View(Tk):
    ...
    def create_frame_widgets(self):
        lbl_radius = Label(self.top_frame, text="Sisesta külg", font=self.default_font)
        lbl_radius.grid(row=0, column=0, padx=5, pady=5)
        lbl_height = Label(self.top_frame, text="Sisesta külg", font=self.default_font)
